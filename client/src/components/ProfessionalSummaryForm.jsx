  ...
  return (
    <div className='space-y-4'>
        <div className='flex items-center justify-between'>
            <div>
                <h3 className='felx items-center gap-2 text-lg font-semibold
        ...
        <div className='mt-6'>
            <textarea value={data || ""} onChange={(e)=> onChange(e.target.value)} rows={7} className="w-full p-3 px-4 mt-2 border text-sm border-gray-300 
            ...
            Keep it concise (3-4 sentences) on your most relevant achievements and skills.</p>
        </div>
    </div>
  )
}

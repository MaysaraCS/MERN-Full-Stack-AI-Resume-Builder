  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='flex gap-2'>
            <input type="text" placeholder="Enter a skill (e.g., JavaScript, Project Managment)" className='flex-1 px-3 py-2 text-sm'
        ...
        <div className='bg-blue-50 p-3 rounded-lg'>
            <p className='text-sm text-blue-800'> <strong>Tip:</strong> Add 8-12 relevant languages, tools, and skills. Include both technical skills 
                (e.g., programming) and soft skills (e.g., leadership, communication).</p>
        </div>
    </div>
  )
}
